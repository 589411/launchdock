...
<!-- @img: ollama-launch-openclaw | ollama launch openclaw 設定頁面 -->
...
> <img src="/images/dock_head_s.png" alt="鴨編" width="24" style="vertical-align: middle;"> **不想佔硬碟空間？** 選雲端模型（如 `kimi-k2.5`），不需下載任何東西，直接透過 Ollama 帳號的免費額度使用。適合先體驗後決定。更多雲端模型可到 [ollama.com](https://ollama.com/search) 搜尋。
