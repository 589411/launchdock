...
export const levels: Record<number, LevelInfo> = {
  ...
  4: {
    ...
    recommended: ['openclaw-agent', 'openclaw-skill', 'from-prompt-to-skill', 'multi-agent-swarm', 'what-is-n8n', 'workflow-reconcile', 'workflow-report', 'workflow-inbox', 'workflow-docdiff'],
  },
};
